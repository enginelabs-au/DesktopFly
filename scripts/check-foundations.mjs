...
for (const rel of [
  ...
  "backend/flysim/config.py",
  "backend/flysim/sensory.py",
  "backend/flysim/motor.py",
  "backend/flysim/device.py",
  "backend/flysim/adapters/malecns.py",
  "backend/flysim/adapters/flywire.py",
  "backend/uv.lock",
  ...
  "reports/device.json",
  "reports/capability.json",
  "reports/performance.json",
  "provenance/malecns-v1.0.json",
  "src/live/stream-adapter.mjs",
  "src/telemetry/health-dashboard.mjs",
  "src/telemetry/health.html",
  "src/workbench/workbench.mjs",
  "desktop/capabilities/broker.mjs",
  "desktop/connectors/manifests.mjs",
  "desktop/layers.mjs",
  "desktop/scene.mjs",
  "docs/handover/mac-verification-runbook.md",
