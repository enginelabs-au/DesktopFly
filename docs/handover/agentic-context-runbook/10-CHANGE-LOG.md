...
| E3 | [GPT-REVIEW-PROMPT.md](GPT-REVIEW-PROMPT.md), [INDEX](INDEX.md), [07](07-REVIEW-AND-CONTRACTS.md) | add | Final GPT copy-paste prompt updated for v1.4: `INDEX.md` and `this-pass/README.md` are in the pack; `this-pass/repo/` holds the canary snapshots; W1/W2/W5 limits restated. | Owner asked to update the handover prompt after the pack became the single artefact folder. |
